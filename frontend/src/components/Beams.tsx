...
// Use THREE.MathUtils to avoid subpath import issues across bundlers
...
function extendMaterial<T extends THREE.Material = THREE.Material>(
  ...
  const physical = THREE.ShaderLib.physical as unknown as ShaderWithDefines;
